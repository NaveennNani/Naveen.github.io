...
MyVideo.addEventListener("timeupdate", function(event){
    ...
    const currentTimeInMinutes = Math.floor (MyCurrentTime / 60)//1.34234
    // console.log(durationInMinutes) // -----> 1
...
ProgressRange.addEventListener("click", function(event){
    ...
    //console.log(totalWidth FromStart)
...
// Which property can be used to get the total width from the start of the progress range where the click action was performed?
// offsetX
...
Volume.addEventListener("click", function(){
    //Logic to make video sound = 0, replace volume button with mute
    MyVideo.volume = 0
